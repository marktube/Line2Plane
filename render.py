...
def createLS(pointset, colors, lidx, cidx):
    ...
    for i in range(len(lidx)):
        ...
        bcurve.data.materials.append(mats[(cidx[i] + 1) % len(colors)])
...
if __name__ == '__main__':
    ...
    pointset, colors, lidx, cidx = loadClusterVg(
        r'D:\Cha0s\Workspace\Blender_rendering\Line2Plane\data\gta5-16\L2P-line3dpp-vsfm-gta5-16-face-inf-var_10_inf.vg')
