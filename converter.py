...
if __name__ == '__main__':
    ...
    prefix = '/home/hiko/Downloads/data/dispatch/other_ball/part_'
    for i in range(len(faces)):
        fpath = prefix+str(i+1)+'.obj'
        with open(fpath, 'w') as fw:
            fw.write('# OBJ generated by LYC\n')
            fw.write(
                'v {} {} {}\n'.format(vertices[faces[i][0]][0], vertices[faces[i][0]][1], vertices[faces[i][0]][2]))
            fw.write(
                'v {} {} {}\n'.format(vertices[faces[i][2]][0], vertices[faces[i][2]][1], vertices[faces[i][2]][2]))
            fw.write(
                'v {} {} {}\n'.format(vertices[faces[i][1]][0], vertices[faces[i][1]][1], vertices[faces[i][1]][2]))
            for j in range(3):
                fw.write('vt 0 0\n')
            fw.write('f 1/1 2/2 3/3\n')
