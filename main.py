...
parser.add_argument('--volume', type=int, default=2, help='Volumes to use [default: volume 2]')
parser.add_argument('--line_data', default='/home/hiko/Workspace/Line2Plane/data/Barn+haoyu_cut8.obj', help='Line data input filepath [default: ]')
