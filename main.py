...
parser.add_argument('--volume', type=int, default=41, help='Volumes to use [default: volume 2]')
parser.add_argument('--line_data', default='data/DJI_modified.obj', help='Line data input filepath [default: ]')
